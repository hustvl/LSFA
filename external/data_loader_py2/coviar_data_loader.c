...
static PyMethodDef CoviarMethods[] = {
    {"load",  (PyCFunction)load, METH_VARARGS, "Load a frame."},
    {"get_num_gops", (PyCFunction)get_num_gops, METH_VARARGS, "Getting number of GOPs in a video."},
    {"get_num_frames", (PyCFunction)get_num_frames, METH_VARARGS, "Getting number of frames in a video."},
    {NULL, NULL, 0, NULL}        /* Sentinel */
};


PyMODINIT_FUNC initcoviar_py2(void)
{
    PyObject *m;
    m = Py_InitModule3("coviar_py2", CoviarMethods, NULL);
    if (m == NULL)
        return NULL;
...
static wchar_t* charToWChar(const char* text)
{
    ...
    wchar_t* wText = (wchar_t*)malloc(size);
...
int main(int argc, char *argv[])
{
    ...
    wchar_t *program = charToWChar(argv[0]); //Py_DecodeLocale(argv[0], NULL);
    if (program == NULL) {
    ...
    PyImport_AppendInittab("coviar_py2", initcoviar_py2);
